...
const appCss = "/human-folio-glow/assets/styles-o32FguoY.css";
...
function TopNav() {
  ...
  const Icon2 = theme === "dark" ? Moon : Sun;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "fixed inset-x-0 top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "font-display text-base font-bold tracking-tight", children: [
      "afiq",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "accent-amber", children: ".dev" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 sm:gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center", children: NAV.map(({ to, label }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              label,
              active && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-x-3 -bottom-px h-px bg-amber" })
            ]
          },
          to
        );
...
const Route$4 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Afiq — Software Engineer" },
      { name: "description", content: "Afiq builds frontend products with strong UI/UX and scalable systems." },
      { name: "author", content: "Afiq" },
      { property: "og:title", content: "Afiq — Software Engineer" },
      { property: "og:description", content: "Afiq builds frontend products with strong UI/UX and scalable systems." },
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-bg relative min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopNav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "mx-auto max-w-7xl px-4 pb-12 pt-20 sm:px-6 lg:px-8 lg:pt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
  ] }) }) });
}
const BASE_URL = "";
...
const $$splitComponentImporter$2 = () => import("./blog-BAQqW5Xs.js");
...
const $$splitComponentImporter$1 = () => import("./about-DcxrKCUI.js");
...
const $$splitComponentImporter = () => import("./index-BDnkpAvH.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Afiq is a software engineer at Siemens building backend systems and AI-powered tools that are clean, scalable, and production-ready."
    }]
  }),
