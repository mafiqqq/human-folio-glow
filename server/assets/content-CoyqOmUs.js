...
import { c as cn } from "./router-Bo3Ips-P.js";
...
function GlassCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: cn("bento", hover2 && "bento-hover", className),
      ...props,
      children
    }
  );
...
function Pill({
  ...
  const styles = {
    outline: "border border-border/80 text-foreground/75 bg-foreground/[0.02] hover:-translate-y-0.5 hover:border-amber/60 hover:text-amber hover:bg-amber-soft hover:shadow-[0_4px_14px_-6px_var(--amber)]",
...
function Label({ children, className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("label-mono", className), children });
}
const PROFILE = {
  name: "Afiq",
  role: "Software Engineer",
  company: "Siemens Industry Software",
  tagline: "I build backend systems and AI-powered tools that are clean, scalable, and production-ready.",
