...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Dxl38bPh.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bo3Ips-P.js").then((n2) => n2.j),
    import("./start-D7eMpDyq.js"),
...
var ROUTER_BASEPATH = "human-folio-glow";
var SERVER_FN_BASE = "/human-folio-glow/_serverFn/";
